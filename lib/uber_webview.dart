    ...
    return SafeArea(
      child: Scaffold(
        body: WebView(
          ...
          // Get the HTML code of the initial page
          String htmlCode = await _controller.evaluateJavascript('document.documentElement.outerHTML');
          log(htmlCode.toString());
